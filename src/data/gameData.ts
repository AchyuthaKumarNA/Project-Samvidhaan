...
export const gameLevels: GameLevel[] = [
  ...
  {
    id: 3,
    title: "Preamble Memory Match",
    description: "Match the Preamble words with their meanings",
    type: "memory",
    difficulty: "easy",
    timeLimit: 150,
    pointsPerQuestion: 10,
    questions: [
      { id: "3-1", question: "Sovereign", answer: "Supreme power", explanation: "India is not subject to any external authority." },
      { id: "3-2", question: "Socialist", answer: "Wealth for all", explanation: "The state works to reduce inequality." },
      { id: "3-3", question: "Secular", answer: "No state religion", explanation: "All religions are treated equally." },
      { id: "3-4", question: "Democratic", answer: "Rule by people", explanation: "Government elected by citizens." },
      { id: "3-5", question: "Republic", answer: "Elected head", explanation: "The President is elected, not hereditary." },
      { id: "3-6", question: "Justice", answer: "Fairness", explanation: "Social, economic and political justice for all." },
    ],
  },
  {
    id: 4,
